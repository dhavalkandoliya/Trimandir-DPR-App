...
// to change at all — only what's behind /api/proxy changed. Write actions
...
// Same rules the UI shows (HistoryScreen editAction / index.html editDPR),
...
// A field whose query failed is simply omitted — index.html's 'bootstrap'
// subscriber already keeps its previous in-memory array for any field that
// isn't an array. Only when EVERY query fails (Supabase unreachable) does
